...
export const confirmEmailAddress = async (user) => {
	...
	const data = {
		to: user.email,
		from: "Anova Online Courses <hello@anova.com>",
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: left;">
                                    ...
                                    <p>Thanks for registering on the Anova! Please click the below link to verify your email address and activate your account.</p>
                                    ...
                                    <p>
                                        Regards, <br />
                                        Anova Support Team <br />
                                        All Rights Reserved by Anova.com
                                    </p>
                                </div>
                            </td>
                        </tr>
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              ...
                              <p style="text-align: center; margin-bottom: 0; margin-top: 5px">
                                  <a href="http://Anova.com/" target="_blank" style="color: #3056de">www.Anova.com</a>
                              </p>
                              </td>
                            </tr>
                          </table>
